...
//             Jingle( const Jingle& right );
        ...
        /**
         * Returns the session's remote.
         * @return The session's remote.
         */
        const JID& remote() const { return m_remote; }
      ...
      private:
         ...
         */
        Session( ClientBase* parent, const JID& callee, SessionHandler* jsh, const std::string &sId = EmptyString);
