...
namespace gloox
{
  ...
  GLOOX_API extern const std::string XMLNS_PUBSUB_PUBLISH_OPTIONS    ;

  GLOOX_API extern const std::string XMLNS_PUBSUB_AUTO_SUBSCRIBE     ;

  GLOOX_API extern const std::string XMLNS_PUBSUB_AUTO_CREATE     ;

  GLOOX_API extern const std::string XMLNS_PUBSUB_NOTIFICATIONS ;
  ...
  GLOOX_API extern const std::string XMLNS_JINGLE_MESSAGE;

  /** XEP-0338: Jingle Grouping Framework*/
  GLOOX_API extern const std::string XMLNS_JINGLE_APPS_GROUP;

  /** Jingle ICE-UDP Transport namespace (@xep{0176}) */
  GLOOX_API extern const std::string XMLNS_JINGLE_ICE_UDP;

  /** XEP-0261: Jingle In-Band Bytestreams Transport Method */
  GLOOX_API extern const std::string XMLNS_JINGLE_IBB;

  GLOOX_API extern const std::string XMLNS_JINGLE_APPS_RTP;
  ...
  /** Avatar (@xep{0084}) */
  GLOOX_API extern const std::string XMLNS_AVATAR;
  GLOOX_API extern const std::string XMLNS_META_AVATAR;
  ...
  enum TLSVersion
  {
    ...
    DTLSv1_2,                       /**< Use this to require DTLS v1.2 as a minimum.
                                     * Requires a datagram-based transport (e.g. UDP). */
    TLSInvalid = 0                  /**< Don't use, undefined behaviour. */
  };
...
//   };
  ...
  enum MUCUserFlag
  {
    ...
    UserAffiliationChangedWNR = 1<<26, /**< The user's affiliation changed While Not in the Room.
                                       * Code: 101 */
    UserRoomConfigurationChanged = 1<<27
  };
